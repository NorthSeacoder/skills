...
check_closeout_ready() {
  ...
  require_grep 'Type[[:space:]]*\|[[:space:]]*Title[[:space:]]*\|[[:space:]]*Summary[[:space:]]*\|[[:space:]]*Evidence[[:space:]]*\|[[:space:]]*Scope[[:space:]]*\|[[:space:]]*Sync Status[[:space:]]*\|[[:space:]]*Follow-up' "$acceptance"
